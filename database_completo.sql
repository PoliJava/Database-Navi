...
1	NavItalia	CAPRI	CASTELLAMMARE	NAPOLI	\N	20	capri-castellammare primavera/estate 2024	0
\.
...
SELECT pg_catalog.setval('public.sequenza_id_passeggero', 127, true);
